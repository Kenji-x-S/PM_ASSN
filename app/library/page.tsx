...
const SOURCES = [
	...
	{
		title: "PMBOK 7",
		file: "/pdfs/Project-Management-Institute-A-Guide-to-the-Project-Management-Body-of-Knowledge-PMBOK-R-Guide-PMBOK®️-Guide-Project-Management-Institute-2021.pdf",
	},
	{
		title: "ISO 21500",
		file: "/pdfs/ISO 21500-2021_ Project, programme and portfolio management - Context and concepts.pdf",
	},
];
						...
						<div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
							<input
								...
								onChange={(e) => {
									...
									setPage(p);
									if (activeFile)
										router.replace(`/library?file=${encodeURIComponent(activeFile)}&page=${p}`);
								}}
								className="input"
								style={{ width: 120 }}
							/>
							<button
								...
								onClick={() => {
									...
									setBookmarks((prev) => [
										...
										{
											title:
												SOURCES.find((s) => s.file === activeFile)?.title ?? "Standard",
											file: activeFile,
											page,
										},
									]);
...
export default function LibraryPage() {
	return (
		<Suspense fallback={<div style={{ padding: 20 }}>Loading library…</div>}>
			<LibraryContent />
		</Suspense>
	);
}
